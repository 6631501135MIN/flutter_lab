...
class Design2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('My Profilel', style: TextStyle(color: Colors.white)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            //https://icons.iconarchive.com/icons/icons8/windows-8/128/Cinema-Superman-icon.png"
            Center(
              child: CircleAvatar(
                radius: 40,
                backgroundColor: Colors.blue,
                backgroundImage: NetworkImage(
                  "https://www.iconarchive.com/download/i10800/fasticon/batman-begins/batman.128.png",
                ),
              ),
            ),
